...
class Bill_App:
    def __init__(self,root):
        ...
        self.root.title("VISHAL PAWAR-> Billing Software")
        bg_color="#074463"
        title=Label(self.root,text="VISHAL Billing Software",bd=12,relief=GROOVE,bg=bg_color,fg="white",font=("times new roman",30,"bold"),pady=2).pack(fill=X)
        #=============================Variables========================================================
        #==========================Cosmetics===========================================================
        self.soap=IntVar()
        ...
        cphn_txt=Entry(F1,width=15,textvariable=self.c_phone,font="ariral 15",bd=7,relief=SUNKEN).grid(row=0,column=3,pady=5,padx=10)
    
        cbill_lbl=Label(F1,text="Bill No.",bg=bg_color,fg="white",font=("times new roman",18,"bold")).grid(row=0,column=4,padx=20,pady=5)
        cbill_txt=Entry(F1,width=15,textvariable=self.search_bill,font="ariral 15",bd=7,relief=SUNKEN).grid(row=0,column=5,pady=5,padx=10)
        ...
        bath_txt=Entry(F2,width="10",textvariable=self.soap,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=0,column=10,pady=10,padx=10)
        ...
        face_cream_txt=Entry(F2,width="10",textvariable=self.face_cream,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=1,column=10,pady=10,padx=10)
        ...
        Face_w_txt=Entry(F2,width="10",textvariable=self.face_wash,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=2,column=10,pady=10,padx=10)
        ...
        Hair_s_txt=Entry(F2,width="10",textvariable=self.spray,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=3,column=10,pady=10,padx=10)
        ...
        Hair_g_txt=Entry(F2,width="10",textvariable=self.gel,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=4,column=10,pady=10,padx=10)
        ...
        Body_l_txt=Entry(F2,width="10",textvariable=self.lotion,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=5,column=10,pady=10,padx=10)
        ...
        g1_txt=Entry(F3,width="10",textvariable=self.rice,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=0,column=10,pady=10,padx=10)
        ...
        g2_txt=Entry(F3,width="10",textvariable=self.food_oil,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=1,column=10,pady=10,padx=10)
        ...
        g3_txt=Entry(F3,width="10",textvariable=self.Daal,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=2,column=10,pady=10,padx=10)
        ...
        g4_txt=Entry(F3,width="10",textvariable=self.Wheat,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=3,column=10,pady=10,padx=10)
        ...
        g5_txt=Entry(F3,width="10",textvariable=self.sugar,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=4,column=10,pady=10,padx=10)
        ...
        g6_txt=Entry(F3,width="10",textvariable=self.tea,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=5,column=10,pady=10,padx=10)
        ...
        c1_txt=Entry(F4,width="10",textvariable=self.maza,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=0,column=10,pady=10,padx=10)
        ...
        c2_txt=Entry(F4,width="10",textvariable=self.cock,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=1,column=10,pady=10,padx=10)
        ...
        c3_txt=Entry(F4,width="10",textvariable=self.frooti,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=2,column=10,pady=10,padx=10)
        
        c4_lbl=Label(F4,text="Thumbsup",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=3,column=0,padx=10,pady=10,sticky="w")
        c4_txt=Entry(F4,width="10",textvariable=self.thumbsup,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=3,column=10,pady=10,padx=10)
        ...
        c5_txt=Entry(F4,width="10",textvariable=self.limca,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=4,column=10,pady=10,padx=10)
        ...
        c6_txt=Entry(F4,width="10",textvariable=self.sprite,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=5,column=10,pady=10,padx=10)
       ...
       #===============================Bill Area=====================================================
        ...
        total_btn=Button(btn_F,command=self.total,text="Total",bg="orange",fg="white",bd=2,pady=15,width=10,font="arial 14 bold").grid(row=0,column=0,padx=5,pady=5)
        GBill_btn=Button(btn_F,text="Generate Bill",command=self.bill_area,bg="orange",fg="white",bd=2,pady=15,width=10,font="arial 14 bold").grid(row=0,column=1,padx=5,pady=5)
        Clear_btn=Button(btn_F,text="Clear",command=self.clear_data,bg="orange",fg="white",bd=2,pady=15,width=10,font="arial 14 bold").grid(row=0,column=2,padx=5,pady=5)
        Exit_btn=Button(btn_F,text="Exit",command=self.Exit_app,bg="orange",fg="white",bd=2,pady=15,width=10,font="arial 14 bold").grid(row=0,column=3,padx=5,pady=5)
        self.welcome_bill()
    ...
    def total(self):
        ...
        self.c_fc_p=self.face_cream.get()*85
        self.c_fw_p=self.face_wash.get()*110
        self.c_hs_p=self.spray.get()*120
        self.c_hg_p=self.gel.get()*50
        self.c_bl_p=self.lotion.get()*170
        ...
        self.g_w_p=self.Wheat.get()*1250
    ...
    def bill_area(self):
        ...
        if self.gel.get()!=0:
            self.txtarea.insert(END,f"\n Hair Gell\t\t{self.gel.get()}\t\t{self.c_hg_p}")        
    ...
    def save_bill(self):
        ...
        if op>0:
            ...
            f1=open("bils/"+str(self.bill_no.get())+".txt","w")
    ...
    def find_bill(self):
        ...
        for i in os.listdir("bils/"):
            if i.split('.')[0]==self.search_bill.get():
                  ...
                  present="yes" 
        if present=="no":
            messagebox.showerror("Error","No such Bill No. avail")
